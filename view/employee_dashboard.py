...
# Display Employee Table with Filters
        ...
        with col1:
            ...
            deployment_filter = st.multiselect("Employee Status", options=employee_df['Employment_Status'].unique(), default=employee_df['Employment_Status'].unique())
            ...
            filtered_employee_df = employee_df[
                ...
                (employee_df['Employment_Status'].isin(deployment_filter)) &
